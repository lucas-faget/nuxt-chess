                ...
                articles: [
                    {
                        ...
                        chess: new TwoPlayerChess(ChessVariant.Standard, "8/8/8/8/2P5/8/5P2/8 w - - 0 1", [Whites]),
                        color: SquareColor.Brown
                    },
                    {
                        title: "Knight",
                        ...
                        chess: new TwoPlayerChess(ChessVariant.Standard, "8/8/8/3N4/8/8/8/8 w - - 0 1", [Whites]),
                    ...
                    },
                    {
                        ...
                        chess: new TwoPlayerChess(ChessVariant.Standard, "8/8/8/8/3B4/8/8/8 w - - 0 1", [Whites]),
                    ...
                    },
                    {
                        ...
                        chess: new TwoPlayerChess(ChessVariant.Standard, "8/8/8/3R4/8/8/8/8 w - - 0 1", [Whites]),
                    ...
                    },
                    {
                        ...
                        chess: new TwoPlayerChess(ChessVariant.Standard, "8/8/8/8/3Q4/8/8/8 w - - 0 1", [Whites]),
                    ...
                    },
                    {
                        ...
                        chess: new TwoPlayerChess(ChessVariant.Standard, "8/8/8/5K2/8/8/8/8 w - - 0 1", [Whites]),
                        color: SquareColor.Brown
                    }
                ]
            };
		...
		<article v-for="(article, index) in articles" :key="index">
            <div class="section">
                <div class="section-header">
                    <img :src="getPieceImageSrc('w' , article.piece)" alt="Piece" />
            ...
            <div class="section">
                <div class="chessboard">
                    <Chessboard
                        :chess="article.chess"
                        :light-square-color="article.color"
                        :dark-square-color="article.color"
                    />
                </div>
            </div>
        </article>
